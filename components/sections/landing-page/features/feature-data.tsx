...
const featuresData: Feature[] = [
  {
    ...
    paragraph:
      "Set up elections with custom parameters (dates, candidates, rules).",
  },
  {
    id: 2,
    icon: (
    ...
    paragraph:
      "Upload voter lists via CSV/Excel for rapid registration.",
  },
  {
    id: 3,
    icon: (
    ...
    title: "Email Alerts",
    paragraph:
      "Notify voters about election start/end, voter details, and reminders.",
  },
  {
    id: 4,
    icon: (
    ...
    paragraph:
      "Archive past elections for public viewing.",
  },
