          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div
                ...
                data-wow-delay=".2s"
              >
                <div className="flex md:flex-row flex-col items-center gap-2 md:h-24 mb-4">
                  <h1 className="mb-5 text-5xl font-bold leading-tight text-primary dark:text-white sm:text-4xl sm:leading-tight md:text-7xl md:leading-tight">
                  VoteBuddy
                </h1>
                ...
                <div className="flex flex-col items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                  ...
                  <Link
                    ...
                    className="inline-block rounded-sm  hover:bg-primary hover:text-primary-foreground px-8 py-4 text-primary border-2 border-primary
                     font-semibold  duration-300 ease-in-out  dark:bg-white/10 dark:text-white dark:hover:bg-white/5"
                  >
                    Create an Election
                  </Link>
                </div>
