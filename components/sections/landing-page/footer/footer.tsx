...
const Footer = () => {
  return (
    <>
      <footer
        className="wow fadeInUp dark:bg-gray-dark relative z-10 bg-accent pt-16 md:pt-20 lg:pt-24"
        data-wow-delay=".1s"
      >
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16 ">
                <Link href="/" className="mb-8 inline-block px-2 py-1">
                  <Image
                    src="/images/logo.png"
                    alt="logo"
        ...
        <div className="absolute right-0 top-14 z-[-1]">
          ...
          >
            <circle opacity="0.8" cx="49.5" cy="49.5" r="49.5" fill="#6366f1" />
            <mask
              id="mask0_94:899"
